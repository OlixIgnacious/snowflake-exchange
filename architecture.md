...
1. This doc (done) + `docs/canonical_schema_contract.md` (done, v4 — `JURISDICTION_ID`/`VENUE_ID` split, a nine-point structural-review fix, and `VENUES` date-bounding for discontinued venues).
