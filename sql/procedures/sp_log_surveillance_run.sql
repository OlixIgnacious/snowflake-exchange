-- SP_LOG_SURVEILLANCE_RUN: runs all four detector views for a given jurisdiction and inserts
...
-- PK), and a shared QUERY_SNAPSHOT_ID ties the four rows to one surveillance run.
--
