...
| `CBOJ` | Cboe Japan (formerly Chi-X Japan) | pts | **Not verified live this session** — cboe.com redirected to the global Cboe Global Markets site, not a Japan-specific page. Corroborated indirectly by ODX's own "third PTS" framing (implying two prior PTS operators — Japannext and, most likely, Cboe Japan), but not confirmed from a primary source. Verify directly before seeding. |
